 ...
 * complete arc. For more information on the arc file format see {@link
...
public class ArcRecordReader extends RecordReader<Text, BytesWritable> {
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    // over seeking
                    LOG.info("Ignoring position: {}", (startRead));
    ...
    public float getProgress() throws IOException, InterruptedException {
        ...
        return (splitEnd == splitStart)?0.0f:Math.min(1.0f, (getPos() - splitStart) / (float) splitLen);
    }
