...
public class  CrawlDbReducer extends
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        additionsAllowed = configuration.getBoolean(CrawlDb.CRAWLDB_ADDITIONS_ALLOWED, true);
        maxInterval = configuration.getInt("db.fetch.interval.max", 0);
                ...
                if (modified == FetchSchedule.STATUS_NOTMODIFIED) {
                    ...
                    switch (fetch.getStatus()) {
                        ...
                        case CrawlDatum.STATUS_FETCH_REDIR_TEMP:
                            ...
                            break;
                        default:
                            LOG.warn("Unexpected status: {} resetting to old status.", fetch.getStatus());
                            if (oldSet)
